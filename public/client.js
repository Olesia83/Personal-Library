$( document ).ready(function() {
  ...
  $('#display').on('click','li.bookItem',function() {
    ...
    $.getJSON('/api/books/'+itemsRaw[this.id]._id, function(data) {
      ...
      comments.push('<br><button class="btn btn-info addComment" style="width:150px" id="'+ data._id+'">Add Comment</button>');
      comments.push('<button class="btn btn-danger deleteBook" style="width:150px" id="'+ data._id+'">Delete Book</button>');
